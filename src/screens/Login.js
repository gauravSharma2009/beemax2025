...
function LoginScreen(props) {
    ...
    const loginComponent = () => (<View style={{ width: '100%', backgroundColor: whiteTxtColor, paddingHorizontal: 20, marginTop: 10, height: '100%', backgroundColor: whiteTxtColor }}>
        <Text
        ...
        <TouchableOpacity
            ...
            style={{ borderColor: buttonBgColor, borderWidth: 1, padding: 10, borderRadius: 5, justifyContent: 'center', alignItems: 'center', marginTop: 20 }}><Text style={{ color: buttonBgColor, fontFamily: 'Poppins-SemiBold', fontSize: 18 }}>Login with OTP</Text></TouchableOpacity>
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ width: "100%", height: '86%', backgroundColor: whiteTxtColor }}>
